import type { ArcanaCombo, SpecialCombo } from '../engine/types';

export const rarePersonae: string[] = [
  "Crystal Skull",
  "Koh-i-Noor",
  "Queen's Necklace",
  "Regent",
...
export const rareCombos: Record<string, number[]> = {
...
export const arcana2Combos: ArcanaCombo[] = [
...
export const dlcPersona: string[][] = [
...
export const confidantNames: Record<string, string> = {
  ...
  "Hierophant": "Sojiro (Hierophant)",
  "Lovers":     "Ann (Lovers)",
  "Chariot":    "Ryuji (Chariot)",
  "Justice":    "Akechi (Justice)",
...
export const inheritanceChart: Record<string, string[]> = {
  "Physical": ["✓","✓","✘","✘","✘","✘","✘","✘","✘","✘","✓","✓"],
  "Fire":     ["✓","✓","✓","✘","✓","✓","✓","✓","✓","✓","✓","✓"],
  "Ice":      ["✓","✓","✘","✓","✓","✓","✓","✓","✓","✓","✓","✓"],
  "Electric": ["✓","✓","✓","✓","✓","✘","✓","✓","✓","✓","✓","✓"],
